                ...
                <tr>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                        ...
                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">SITE: ACI 2000</p>
...
const pipelineTwo = [
    ...
    Stock.watch(pipeline, {fullDocument: 'updateLookup'}).
...
Order.watch(pipelineTwo, {fullDocument: 'updateLookup'}).
        on('change', async (data) => {
...
//Fin d envoie
module.exports = {Stock, Notification,Order, validateStock, validateNotification};
